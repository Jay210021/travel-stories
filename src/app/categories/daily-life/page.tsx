...
import { getPublicTaxon, listStoriesForTaxon } from "@/lib/public-reading";

export default async function DailyLifePage() {
  const taxon = await getPublicTaxon("daily-life");
  const stories = taxon ? await listStoriesForTaxon(taxon) : [];
